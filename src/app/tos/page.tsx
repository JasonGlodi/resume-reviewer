...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to AI Resume Reviewer. These Terms of Service
        (&quot;Terms&quot;) govern your use of our website and services,
        including any paid subscription plans. By accessing or using AI Resume
        Reviewer (&quot;the Service&quot;), you agree to be bound by these
        Terms. If you do not agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        AI Resume Reviewer is a SaaS platform that provides resume-building
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> AI Resume Reviewer does not offer
      ...
      <p>
        AI Resume Reviewer grants you a limited, non-exclusive,
        non-transferable, and revocable license to use the Service for personal
        or professional use in accordance with these Terms. You may not:
      </p>
      <ul className="list-inside list-disc">
      ...
      <p>
        ...
        Resume Reviewer are owned by AI Resume Reviewer or its licensors. You
        agree not to infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant AI Resume Reviewer a non-exclusive,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). AI Resume Reviewer is not
      ...
      <p>
        ...
        available&quot; basis. AI Resume Reviewer makes no warranties, express
        or implied, regarding the Service, including but not limited to the
      ...
      <p>
        To the fullest extent permitted by law, AI Resume Reviewer shall not be
      ...
      <p>
        By using AI Resume Reviewer, you acknowledge that you have read,
